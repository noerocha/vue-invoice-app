...
export default {
  ...
  methods: {
    ...
    calculateInvoiceTotal() {
      const total = this.invoiceItemList.reduce(
    ...
    async uploadInvoice() {
      if (this.invoiceItemList.length <= 0) {
        alert("Please make sure you filled out work items !");
        return;
      }
    ...
    async updateInvoice() {
      ...
      const document = db.collection("invoices").doc(this.docId);
